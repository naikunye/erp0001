  ...
  const executeAiCommand = async () => {
      ...
      try {
          ...
          const prompt = `
            ...
            Available Pages: dashboard, finance, customers, tracking, marketing, intelligence (AI Lab), calendar, replenishment (TikTok List), suppliers, settings.
            
            User Intent: "${query}"
            
            Return a JSON object:
            {
                "action": "navigate" | "filter_products" | "unknown",
